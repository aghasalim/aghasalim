...
so I check my own numbers before anyone else does. The badge below is a CI job
that reads the figures on this page and fails if they stop matching the
...
[Kaggle](https://www.kaggle.com/aghasalimmustafazada) graded against labels I
never got to see.
